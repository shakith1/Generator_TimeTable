 ...
 * @author Shakith
 */
public class add_notAvailable_lecturers extends javax.swing.JPanel {
    ...
    /**
     * Creates new form add_notAvailable_lecturers
     */
    public add_notAvailable_lecturers() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel115.setText("Add Not Available Times - Lecturers");
        ...
        jPanel22.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 70, 340, 36));
        ...
        notAvailable_lecturersLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, notAvailable_lecturersLayout.createSequentialGroup()
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable2.getRowCount(); i++) {
                DBConnect.iud("INSERT INTO notavailable_lec VALUES('" + id + "','" + jComboBox1.getSelectedItem().toString() + "','" + model.getValueAt(i, 0) + "','" + model.getValueAt(i, 1) + "','" + model.getValueAt(i, 2) + "')");
                id++;
            }
    ...
    public void loadCombo() {
        try {
            String qry = "SELECT lec.name FROM lec";
    ...
    public void loadId() {
        try {
            String qry = "SELECT COUNT(notavailable_lec.id) as count FROM notavailable_lec";
            ResultSet rs = DBConnect.search(qry);
            rs.next();
