 ...
 * @author Shakith
 */
public class add_notAvailable_subgroups extends javax.swing.JPanel {
    ...
    /**
     * Creates new form add_notAvailable_subgroups
     */
    public add_notAvailable_subgroups() {
        initComponents();
        loadCombo();
        loadId();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < jTable2.getRowCount(); i++) {
                DBConnect.iud("INSERT INTO notavailable_subgroups VALUES('" + id + "','" + jComboBox1.getSelectedItem().toString() + "','" + model.getValueAt(i, 0) + "','" + model.getValueAt(i, 1) + "','" + model.getValueAt(i, 2) + "')");
                id++;
            }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= subgroup_int; i++) {
                    jComboBox1.addItem(group.concat(".").concat(String.valueOf(i)));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void loadId() {
        try {
            String qry = "SELECT COUNT(notavailable_subgroups.id) as count FROM notavailable_subgroups";
            ResultSet rs = DBConnect.search(qry);
            rs.next();
