 ...
 * @author Shakith
 */
public class parellel_sessions extends javax.swing.JPanel {

    Generator generator;

    /**
     * Creates new form parellel_sessions
     */
    public parellel_sessions() {
        initComponents();
    ...
    private void initComponents() {
        ...
        parellel_sessions = new javax.swing.JPanel();
        ...
        parellel_sessions.setBackground(new java.awt.Color(102, 51, 109));
        ...
        jLabel115.setText("Parellel Sessions");
        ...
        javax.swing.GroupLayout parellel_sessionsLayout = new javax.swing.GroupLayout(parellel_sessions);
        parellel_sessions.setLayout(parellel_sessionsLayout);
        parellel_sessionsLayout.setHorizontalGroup(
            parellel_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(parellel_sessionsLayout.createSequentialGroup()
                .addComponent(jPanel40, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 2536, Short.MAX_VALUE))
            .addGroup(parellel_sessionsLayout.createSequentialGroup()
                .addGroup(parellel_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(parellel_sessionsLayout.createSequentialGroup()
                        .addGap(784, 784, 784)
        ...
        parellel_sessionsLayout.setVerticalGroup(
            parellel_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(parellel_sessionsLayout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(jPanel40, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(parellel_sessions, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel71MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel71MouseClicked
        // TODO add your handling code here:
        generator.Parent.removeAll();
        generator.Parent.add(new add_parellel_sessions());
        generator.Parent.repaint();
        generator.Parent.revalidate();
    ...
    private javax.swing.JPanel parellel_sessions;
    // End of variables declaration//GEN-END:variables

    public void loadData() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable2.getModel();
            String qry = "SELECT * FROM parellel_sessions";
            ResultSet rs = DBConnect.search(qry);
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("parellel_sessions.id"));
                v.add(rs.getString("parellel_sessions.batch"));
                v.add(rs.getString("parellel_sessions.session_1"));
                v.add(rs.getString("parellel_sessions.session_2"));
                v.add(rs.getString("parellel_sessions.session_3"));
                dtm.addRow(v);
            }
