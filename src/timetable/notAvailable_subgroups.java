 ...
 * @author Shakith
 */
public class notAvailable_subgroups extends javax.swing.JPanel {

    Generator generator;

    /**
     * Creates new form notAvailable_subgroups
     */
    public notAvailable_subgroups() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel115.setText("Not Available Times - Subgroups");
        ...
        notAvailable_groupsLayout.setHorizontalGroup(
            ...
            .addGroup(notAvailable_groupsLayout.createSequentialGroup()
                .addGroup(notAvailable_groupsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(notAvailable_groupsLayout.createSequentialGroup()
                        .addGap(784, 784, 784)
    ...
    private void jLabel71MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel71MouseClicked
        // TODO add your handling code here:
        generator.Parent.removeAll();
        generator.Parent.add(new add_notAvailable_subgroups());
        generator.Parent.repaint();
        generator.Parent.revalidate();
    ...
    public void loadData() {
        try {
            ...
            String qry = "SELECT * FROM notavailable_subgroups";
            ResultSet rs = DBConnect.search(qry);
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("notavailable_subgroups.id"));
                v.add(rs.getString("notavailable_subgroups.subgroup"));
                v.add(rs.getString("notavailable_subgroups.day"));
                v.add(rs.getString("notavailable_subgroups.from"));
                v.add(rs.getString("notavailable_subgroups.to"));
                dtm.addRow(v);
            }
