 ...
 * @author Shakith
 */
public class notAvailable_sessions extends javax.swing.JPanel {

    Generator generator;

    /**
     * Creates new form notAvailable_sessions
     */
    public notAvailable_sessions() {
        initComponents();
    ...
    private void initComponents() {
        ...
        notAvailable_sessions = new javax.swing.JPanel();
        ...
        notAvailable_sessions.setBackground(new java.awt.Color(102, 51, 109));
        ...
        jLabel115.setText("Not Available Times - Sessions");
        ...
        javax.swing.GroupLayout notAvailable_sessionsLayout = new javax.swing.GroupLayout(notAvailable_sessions);
        notAvailable_sessions.setLayout(notAvailable_sessionsLayout);
        notAvailable_sessionsLayout.setHorizontalGroup(
            notAvailable_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(notAvailable_sessionsLayout.createSequentialGroup()
                .addComponent(jPanel40, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 2536, Short.MAX_VALUE))
            .addGroup(notAvailable_sessionsLayout.createSequentialGroup()
                .addGroup(notAvailable_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(notAvailable_sessionsLayout.createSequentialGroup()
                        .addGap(784, 784, 784)
        ...
        notAvailable_sessionsLayout.setVerticalGroup(
            notAvailable_sessionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(notAvailable_sessionsLayout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(jPanel40, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(notAvailable_sessions, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel71MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel71MouseClicked
        // TODO add your handling code here:
        generator.Parent.removeAll();
        generator.Parent.add(new add_notAvailable_sessions());
        generator.Parent.repaint();
        generator.Parent.revalidate();
    ...
    private javax.swing.JPanel notAvailable_sessions;
    // End of variables declaration//GEN-END:variables

    public void loadData() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable2.getModel();
            String qry = "SELECT * FROM notavailable_sessions";
            ResultSet rs = DBConnect.search(qry);
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("notavailable_sessions.id"));
                v.add(rs.getString("notavailable_sessions.session"));
                v.add(rs.getString("notavailable_sessions.day"));
                v.add(rs.getString("notavailable_sessions.from"));
                v.add(rs.getString("notavailable_sessions.to"));
                dtm.addRow(v);
            }
