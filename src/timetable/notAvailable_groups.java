 ...
 * @author Shakith
 */
public class notAvailable_groups extends javax.swing.JPanel {

    Generator generator;

    /**
     * Creates new form notAvailable_groups
     */
    public notAvailable_groups() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel115.setText("Not Available Times - Groups");
    ...
    private void jLabel71MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel71MouseClicked
        // TODO add your handling code here:
        generator.Parent.removeAll();
        generator.Parent.add(new add_notAvailable_groups());
        generator.Parent.repaint();
        generator.Parent.revalidate();
    ...
    public void loadData() {
        try {
            ...
            String qry = "SELECT * FROM notavailable_groups";
            ResultSet rs = DBConnect.search(qry);
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("notavailable_groups.id"));
                v.add(rs.getString("notavailable_groups.group"));
                v.add(rs.getString("notavailable_groups.day"));
                v.add(rs.getString("notavailable_groups.from"));
                v.add(rs.getString("notavailable_groups.to"));
                dtm.addRow(v);
            }
